...
plugins {
    ...
    // Stage 2 POC: io.sentry.jvm.gradle removed (was uploading source maps / adding Sentry SDK).
}
...
dependencies {
    ...
    // Stage 2 POC: com.posthog.java removed; ContinuePostHogService stubbed.
