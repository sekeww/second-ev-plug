...
// Stage 3 config lockdown: any HTTP egress must stay on loopback. This
// guard catches anything that bypasses the per-provider apiBase override
// — telemetry stubs with lingering URLs, future regressions, etc.
