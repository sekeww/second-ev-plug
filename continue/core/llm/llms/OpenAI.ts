...
import { INTERNAL_LLM_URL } from "../../util/internalEndpoint.js";
...
class OpenAI extends BaseLLM {
  ...
  constructor(options: LLMOptions) {
    ...
    // apiKey the user set in config.yaml is discarded — this build can only
    // talk to the internal LLM endpoint.
